	...
	<div class="navigation-wrapper">
		...
		<div class="main-navigation-area d-none d-lg-block">
			<div class="main-navigation <?php echo esc_attr(medazin_sticky_menu()); ?>">
				<div class="container shape-main">
					<div class="menu-bg-elements-left">
						<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/home2-element.png'); ?>"
							alt="<?php echo esc_attr__('Image', 'doctorhub'); ?>" class="element1">
					</div>
					<div class="menu-bg-elements-right">
						<img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/home2-element.png'); ?>"
							alt="<?php echo esc_attr__('Image', 'doctorhub'); ?>" class="element2">
					</div>
					<div class="row d-flex align-items-center bg-element">
